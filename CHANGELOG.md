...
- `humio` exporter to export data to Humio using JSON over the HTTP [Ingest API](https://web.archive.org/web/20221203221909/https://library.humio.com/humio-server/api-ingest.html) _this is product no longer exists_
